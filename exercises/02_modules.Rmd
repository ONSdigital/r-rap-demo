...
**Tasks:**
- Add your functions to an appropriate module in `R/R_rap_demo`
...
As an additional challenge, Add code to create visualisations. Place all visualisation functions in a separate module (e.g., `report.R`).
