...
2. **Write your code** in the notebook cells or in the `R/R_rap_demo/` modules as instructed.
...
- Place reusable functions and classes in the appropriate module in `R/R_rap_demo/` (e.g., `cleaning.R`, `io.R`, `report.R`).
