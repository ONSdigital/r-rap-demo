...
source("D:/repos/R_rap_demo/R/R_rap_demo/io.R")
source("D:/repos/R_rap_demo/R/R_rap_demo/processing.R")
source("D:/repos/R_rap_demo/R/R_rap_demo/report.R")
source("D:/repos/R_rap_demo/R/R_rap_demo/utils.R")
...
# Output path
output_path <- "D:/repos/R_rap_demo/data/outputs/cleaned/health_data_cleaned"
```
...
Create a function to read config values in a new module, e.g., `R/R_rap_demo/io.R`:
...
Update your pipeline (e.g., in `main.R` or a cleaning module) to use the config-driven parameter for filtering:
...
Create a modular function to save output in the desired format, e.g., in `R/R_rap_demo/io.R`:
